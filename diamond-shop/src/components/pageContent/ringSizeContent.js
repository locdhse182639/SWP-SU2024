...
const RingSizeGuide = () => {
    return (
        <Container style={{ backgroundColor: 'white', paddingTop: '1%', paddingBottom: '2%' }}>
            ...
            <Typography style={{ textAlign: 'left' }} variant="body2" color="textSecondary">
                3. Measure the string or paper with a ruler (mm) then divide by 3.14 (or Pi) to get the diameter of the ring.             </Typography>
            <Typography style={{ textAlign: 'left' }} variant="body2" color="textSecondary">
